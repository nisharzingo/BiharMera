...
public class FollowingProfileListAdapter extends RecyclerView.Adapter<FollowingProfileListAdapter.ViewHolder> {
    private Context context;
    private ArrayList<FollowsWithMapping> list;
    public FollowingProfileListAdapter(Context context,ArrayList<FollowsWithMapping> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(profiles!=null){
            ...
            final UserProfile profile = profiles.getFollowers();
            if(profile!=null) {
