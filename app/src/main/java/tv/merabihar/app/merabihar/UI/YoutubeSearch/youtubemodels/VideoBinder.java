...
import tv.merabihar.app.merabihar.UI.YoutubeSearch.IFragmentManager;
import tv.merabihar.app.merabihar.UI.YoutubeSearch.YoutubeVideoViewHolder;
...
public class VideoBinder {
    ...
    public void bind(final YoutubeVideoViewHolder videoViewHolder, final IFragmentManager fragmentManager) {
    ...
    private void bindVideo(final YoutubeVideoViewHolder viewHolder,
    ...
    private void bindTitle(final YoutubeVideoViewHolder videoViewHolder) {
        videoViewHolder.title.setText(video.title);
    }

    private void bindDescription(final YoutubeVideoViewHolder videoViewHolder) {
        videoViewHolder.description.setText(video.description);
    }

    private void handleClick(final YoutubeVideoViewHolder viewHolder,
                             final IFragmentManager fragmentManager) {
    ...
    public void unBind(final YoutubeVideoViewHolder videoViewHolder, IFragmentManager fragmentManager) {
