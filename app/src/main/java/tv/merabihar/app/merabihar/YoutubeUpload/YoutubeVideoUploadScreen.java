...
public class YoutubeVideoUploadScreen extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
           ...
           // setContentView(R.layout.activity_youtube_video_upload_screen);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(ACCOUNT_KEY, "");
    }
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(YoutubeVideoUploadScreen.this, Constants.APP_NAME, e);
                }
                return null;
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, YoutubeVideoUploadScreen.this,
