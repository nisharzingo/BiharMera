...
/*9C9C9C*/
            labelHome.setText(getResources().getString(R.string.invite));

            tabHome.setIndicator(tabIndicatorInvite);
            Intent dash = new Intent(this, InviteFriendsScreen.class);
            tabHome.setContent(dash);

            labelSearch.setText(getResources().getString(R.string.friend));
