...
public class InterestContentListScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            setContentView(R.layout.activity_interest_content_list_screen);
            ...
            adapter = new ContentAdapterVertical(InterestContentListScreen.this);

            linearLayoutManager = new LinearLayoutManager(InterestContentListScreen.this,LinearLayoutManager.VERTICAL,false);
            mInterestList.setLayoutManager(linearLayoutManager);
            mInterestList.setNestedScrollingEnabled(false);

            final Bundle bundle = getIntent().getExtras();
            if(bundle!=null){
                category = (Interest) bundle.getSerializable("Interest");
            }
    ...
    public void loadFirstSetOfContents(final int id)
    {
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                Call<ArrayList<Contents>> getCat = categoryAPI.getContentPageByInterestId(id,1,5);
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                Call<ArrayList<Contents>> getAllBookings = bookingApi.
                        getContentPageByInterestId(id,currentPage,5);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case android.R.id.home:
                InterestContentListScreen.this.finish();
                break;
        }
